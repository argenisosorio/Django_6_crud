...
class Register(models.Model):
    ...
    marca_cpu = models.CharField(max_length=100, blank=True, null=True)
    mod_cpu = models.CharField(max_length=100, blank=True, null=True)
    serial_cpu = models.CharField(max_length=100, blank=True, null=True)
