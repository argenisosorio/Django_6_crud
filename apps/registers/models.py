...
class Register(models.Model):
    ...
    marca_mouse = models.CharField(max_length=100, blank=True, null=True)
    mod_mouse = models.CharField(max_length=100, blank=True, null=True)
    ...
    nb_ups = models.CharField(max_length=100, blank=True, null=True)
